...
class PythonCodeGeneratorTest {
    ...
    fun generates_skeleton_function_for_TWO_SUM(){
        val twoSumGenerated = pythonCodeGenerator.generateEmptyFunction(TWO_SUM)
    ...
    fun generates_skeleton_function_for_DUMMY_FUNCTION_with_doubles() {
        val generatedCode = pythonCodeGenerator.generateEmptyFunction(DUMMY_FUNCTION)
    ...
    fun generates_skeleton_function_for_INSERT_RANGES_with_generics() {
        val generatedCode = pythonCodeGenerator.generateEmptyFunction(INSERT_RANGE)
        val expectedCode = """class Solution:
